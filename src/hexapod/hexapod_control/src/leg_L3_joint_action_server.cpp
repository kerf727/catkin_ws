...
public:
        ...
        actionName(name)
    {
        ...
        this->hip1JointPublisher = node.advertise<std_msgs::Float64>("/hexapod/leg_L3/hip1_joint_position_controller/command", 1);
        this->hip2JointPublisher = node.advertise<std_msgs::Float64>("/hexapod/leg_L3/hip2_joint_position_controller/command", 1);
