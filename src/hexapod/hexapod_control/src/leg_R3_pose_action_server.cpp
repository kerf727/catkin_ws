...
public:
    SetPoseAction(std::string name) :
        ...
        client("leg_R3_joint_action", true),
        actionName(name)
    {
        this->node = node;
        ...
        this->ikClient = node.serviceClient<hexapod_control::SolveIKPose>("/hexapod/leg_R3/ik");
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "leg_R3_pose_action");
    ROS_INFO("Initialized ros...");

    SetPoseAction actionServer("leg_R3_pose_action");
