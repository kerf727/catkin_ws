...
public:
	...
	void executeCB(const hexapod_control::GaitGoalConstPtr& goal)
	{
		...
		while (true)
		{
            ...
            foot_position.x = default_foot_x - (hip_position.x - default_hip_position_x);
            foot_position.y = default_foot_y - (hip_position.y - default_hip_position_y);
            foot_position.z = default_foot_z - (hip_position.z - default_hip_position_z);
...
private:
    ...
    double default_foot_x = -0.08232;
    double default_foot_y = 0.1426;
    double default_foot_z = -0.03928;
    double default_hip_position_x = -0.04;
    double default_hip_position_y = 0.069282;
    double default_hip_position_z = 0.0;
    bool stop = false;
    ...
    geometry_msgs::Point calcHips(geometry_msgs::Twist twist)
    {
        ...
        std::vector<double> s = {-Rb*cos(60*M_PI/180), Rb*sin(60*M_PI/180), 0}; // specific to L1
