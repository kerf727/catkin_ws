...
public:
        ...
        actionName(name)
    {
        ...
        this->hipJointPublisher = node.advertise<std_msgs::Float64>("/hexapod/leg_R1/hip_joint_position_controller/command", 1);
        this->kneeJointPublisher = node.advertise<std_msgs::Float64>("/hexapod/leg_R1/knee_joint_position_controller/command", 1);
        this->ankleJointPublisher = node.advertise<std_msgs::Float64>("/hexapod/leg_R1/ankle_joint_position_controller/command", 1);
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "leg_R1_joint_action");

    SetJointAction actionServer("leg_R1_joint_action");
    ros::spin();
    return 0;
}