...
public:
    SetPoseAction(std::string name) :
        ...
        client("leg_L3_joint_action", true),
        actionName(name)
    {
        this->node = node;
        ...
        this->ikClient = node.serviceClient<hexapod_control::SolveIKPose>("/hexapod/leg_L3/ik");
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "leg_L3_pose_action");
    ROS_INFO("Initialized ros...");

    SetPoseAction actionServer("leg_L3_pose_action");
